...
public class UpdatedStockMapper {
    public static Stock toStockToUpdate(UpdatedStockDTO updatedStockDTO, long id) throws InvalidStockDTOException {
        ControllerValidation.validateUpdatedStockDTO(updatedStockDTO);
